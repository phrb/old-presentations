...
** Dockerfiles: A Simple Bulletin Board
   #+begin_SRC shell :results output :session *shell* :eval no-export :exports code :tangle ./src/bulletin_dockerfile/clone.sh
   git clone https://github.com/dockersamples/node-bulletin-board
   cd node-bulletin-board/bulletin-board-app
   #+end_SRC

   #+RESULTS:
   : git clone https://github.com/dockersamples/node-bulletin-board   [32mg[32mi[32mt[39m clone https://github.com/dockersamples/node-bulletin-board[?2004l
   ...
   #+begin_SRC shell :results output :session *shell* :eval no-export :exports code :tangle ./src/bulletin_dockerfile/build_run.sh
   cd node-bulletin-board/bulletin-board-app
   ...
   #+begin_SRC shell :results output :session *shell* :eval no-export :exports code :tangle ./src/bulletin_dockerfile/cleanup.sh
   cd node-bulletin-board/bulletin-board-app
...
* Docker Compose
** Combining Services with Docker Compose: A Flask Server
...
*** Flask + Redis Dockerfile                                        :B_block:
    :PROPERTIES:
    :BEAMER_env: block
    :END:
