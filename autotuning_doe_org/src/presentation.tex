...
\section{Autotuning}
\label{sec:org56d2f39}
\begin{frame}[fragile,label={sec:orgbc27fc6}]{Autotuning: Optimizing Program Configurations}
 \begin{columns}
...
\begin{frame}[label={sec:org4c52c38}]{Autotuning: Search Spaces}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:orgdfd390c}]{Autotuning: Exploring Search Spaces}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0e72660}]{Autotuning: Multiple Approaches}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\label{sec:orgeddd553}
\begin{frame}[label={sec:orgf42ba85}]{Applying Design of Experiments to Autotuning}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:orge1a1ced}]{Screening Designs}
\begin{columns}
\begin{column}{0.5\columnwidth}
\vspace{.4cm}
...
\begin{frame}[label={sec:orgd095dbd}]{Looking at Data: CUDA Compiler Flags}
\begin{columns}
...
\begin{frame}[label={sec:org878c234}]{Mixed-Level Designs}
\begin{columns}
\begin{column}{0.5\columnwidth}
\vspace{.1cm}
...
\begin{frame}[label={sec:org33e0cd4}]{Looking at Data: FPGA Compiler Parameters}
\begin{columns}
...
\label{sec:org1994099}
\begin{frame}[label={sec:orged36c3d}]{D-Optimal Designs: Introduction}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
Gathering each \alert{experiment}
...
\begin{frame}[fragile,label={sec:org4ca344a}]{D-Optimal Designs: Example}
 \begin{columns}
\begin{column}{0.5\columnwidth}
\begin{block}{Example}
\begin{itemize}
...
\label{sec:org00bbe12}
\begin{frame}[label={sec:org783c26d}]{Perspectives}
\begin{columns}
\begin{column}{0.5\columnwidth}
