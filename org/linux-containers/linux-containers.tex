...
\label{sec:orga7aa00f}
\begin{frame}[label={sec:orgd8eb795}]{What are Simulation, Emulation, Virtualization?}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org67e5a81}]{OS-Level Virtualization}
\begin{center}
\includegraphics[width=.7\columnwidth]{../../img/virtualization_concept.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org96aa01c}]{OS-Level Virtualization on Linux}
\begin{center}
\includegraphics[width=\columnwidth]{../../img/virtualization_normal_kernel.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org065c834}]{OS-Level Virtualization on Linux}
\begin{center}
