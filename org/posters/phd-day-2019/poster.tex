...
\item \alert{Design of Experiments (DoE)} guides exploration (steps \alert{3} \& \alert{4})
...
\item We evaluated \alert{DLMT} on \alert{11 kernels} (\alert{3} shown below)
