...
\section{Autotuning}
\label{sec:orgef8c04b}
\begin{frame}[label={sec:org75ea980},fragile]{Autotuning: Optimizing Program Configurations}
 \begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3be09c5}]{Design Efficiency}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:orgced4399}]{GPU Laplacian Kernel: A Motivating Example}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{table}[ht]
\centering
...
\begin{frame}[label={sec:orgec7d2b0}]{Conclusion}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{block}{Summary}
\vspace{.2cm}
...
\maketitle
\begin{frame}[label={sec:org549b875}]{SPAPT: Preliminary Results}
\begin{center}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd2377b0}]{Applying Design of Experiments to Autotuning}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{block}{Our Approach}
...
\begin{frame}[label={sec:org6dcfeb9}]{Screening Designs}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.5\columnwidth}
\vspace{.4cm}
...
\begin{frame}[label={sec:org4615310}]{Looking at Data: CUDA Compiler Flags}
\addtocounter{framenumber}{-1}
\begin{columns}
...
\begin{frame}[label={sec:org67ffda4}]{Mixed-Level Designs}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.5\columnwidth}
\vspace{.1cm}
...
\begin{frame}[label={sec:orgd5313a1}]{Looking at Data: FPGA Compiler Parameters}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.4\columnwidth}
