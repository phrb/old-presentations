...
*** A Rails Dockerfile                                              :B_block:
    :PROPERTIES:
    :BEAMER_env: block
    :END:

    #+begin_SRC dockerfile :results output :eval no-export :exports code :tangle ./src/rails_postgres/Dockerfile
    FROM ruby:2.5
...
** Combining Services with Docker Compose
*** Entry-point Script                                              :B_block:
    :PROPERTIES:
    :BEAMER_env: block
    :END:

    #+begin_SRC bash :results output :eval no-export :exports code :tangle ./src/rails_postgres/entrypoint.sh
    #!/bin/bash
...
*** Docker Compose Configuration                                    :B_block:
    ...
    #+begin_SRC yaml :results output :eval no-export :exports code :tangle ./src/rails_postgres/docker-compose.yml
    version: '3'
    services:
      db:
        image: postgres
    ...
    #+end_src
** Combining Services with Docker Compose
*** Docker Compose Database Configuration                           :B_block:
    :PROPERTIES:
    :BEAMER_env: block
    :END:

    #+begin_SRC yaml :results output :eval no-export :exports code :tangle ./src/rails_postgres/config/database.yml
    default: &default
      adapter: postgresql
      encoding: unicode
      host: db
