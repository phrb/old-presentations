...
\section{Autotuning}
\label{sec:orge6f1fd8}
\begin{frame}[fragile,label={sec:org0d41faf}]{Autotuning: Optimizing Program Configurations}
 \begin{columns}
...
\begin{frame}[label={sec:orgfa202cb}]{Autotuning: Search Spaces}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:orgd69b5a8}]{Autotuning: Exploring Search Spaces}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org07dfd56}]{Autotuning: Multiple Approaches}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\label{sec:org964b45b}
\begin{frame}[label={sec:org877662d}]{Applying Design of Experiments to Autotuning}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org73cb229}]{Screening Designs}
\begin{columns}
\begin{column}{0.5\columnwidth}
\vspace{.4cm}
...
\begin{frame}[label={sec:orgc9ea753}]{Looking at Data: CUDA Compiler Flags}
\begin{columns}
...
\begin{frame}[label={sec:org1cbbde0}]{Mixed-Level Designs}
\begin{columns}
\begin{column}{0.5\columnwidth}
\vspace{.1cm}
...
\begin{frame}[label={sec:org3883ae8}]{Looking at Data: FPGA Compiler Parameters}
\begin{columns}
...
\label{sec:org2757df9}
\begin{frame}[label={sec:org329c5ee}]{Perspectives}
\begin{columns}
\begin{column}{0.5\columnwidth}
