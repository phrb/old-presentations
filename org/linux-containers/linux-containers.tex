...
\label{sec:org69afdb2}
\begin{frame}[label={sec:org0d8aeff}]{What are Simulation, Emulation, Virtualization?}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2c4131e}]{OS-Level Virtualization}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgdca4dbf}]{OS-Level Virtualization on Linux}
\begin{center}
\includegraphics[width=\columnwidth]{../../img/virtualization_normal_kernel.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org5d14a2d}]{OS-Level Virtualization on Linux}
\begin{center}
\includegraphics[width=\columnwidth]{../../img/virtualization_kernel.pdf}
\end{center}
\end{frame}
\section{Containers on Linux}
\label{sec:org279ac04}
\begin{frame}[label={sec:org1f71f0f}]{How do Containers Work?}
\begin{center}
\includegraphics[width=.81\columnwidth]{../../img/how-containers-work_pg0.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org8b5ae0d}]{How do Containers Work?}
Images used \alert{with permission}:
\begin{center}
\includegraphics[width=.72\columnwidth]{../../img/hcw_permission_twitter.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org7c75d1c}]{Containers on Linux are Just Processes}
\begin{center}
\includegraphics[width=.86\columnwidth]{../../img/how-containers-work_pg7.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org8353752}]{Containers on Linux use Some Kernel Features}
\begin{center}
\includegraphics[width=.86\columnwidth]{../../img/how-containers-work_pg8.pdf}
\end{center}
\end{frame}
\section{Containers from Scratch}
\label{sec:org1befe20}
\begin{frame}[label={sec:orgebb22df},fragile]{Containers from Scratch: Obtaing an Image}
 \begin{columns}
...
\begin{frame}[label={sec:org28a5f18},fragile]{Containers from Scratch: Creating cgroups and Setting Limits}
