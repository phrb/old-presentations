...
\label{sec:orgdf9c78e}
\begin{frame}[label={sec:org723c931}]{What are Simulation, Emulation, Virtualization?}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org57f1b97}]{OS-Level Virtualization}
\begin{center}
\includegraphics[width=.7\columnwidth]{../../img/virtualization_concept.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orga1514b9}]{OS-Level Virtualization: Scope of this Talk}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7ed8e89}]{OS-Level Virtualization on Linux}
\begin{center}
\includegraphics[width=\columnwidth]{../../img/virtualization_normal_kernel.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc21b8f9}]{OS-Level Virtualization on Linux}
\begin{center}
\includegraphics[width=\columnwidth]{../../img/virtualization_kernel.pdf}
\end{center}
\end{frame}
\section{Containers on Linux}
\label{sec:orgce13197}
\begin{frame}[label={sec:orgb5bb52b}]{How do Containers Work?}
\begin{center}
\includegraphics[width=.81\columnwidth]{../../img/how-containers-work_pg0.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org0d1587a}]{How do Containers Work?}
Images used \alert{with permission}:
\begin{center}
\includegraphics[width=.72\columnwidth]{../../img/hcw_permission_twitter.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org794209a}]{Containers on Linux are Just Processes}
\begin{center}
\includegraphics[width=.86\columnwidth]{../../img/how-containers-work_pg7.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd2ed734}]{Containers on Linux use Some Kernel Features}
\begin{center}
\includegraphics[width=.86\columnwidth]{../../img/how-containers-work_pg8.pdf}
\end{center}
\end{frame}
\section{Containers from Scratch}
\label{sec:org4c178d9}
\begin{frame}[label={sec:orgd4e33a1},fragile]{Containers from Scratch: Obtaing an Image}
 \begin{columns}
...
\begin{frame}[label={sec:org5f27727},fragile]{Containers from Scratch: Creating cgroups and Setting Limits}
...
\begin{frame}[label={sec:org9e94d09},fragile]{Containers from Scratch: Launching our Alpine Container}
 \begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org7e7606f}]{Containers from Scratch: Resources}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{block}{Talks}
\begin{itemize}
...
\label{sec:orgb7d63bb}
\begin{frame}[label={sec:orgf02e781},fragile]{The Docker API for Containers}
 \only<1>{
\begin{center}
...
\begin{frame}[label={sec:org9f75eb9},fragile]{The Docker API for Containers}
