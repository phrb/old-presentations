...
\label{sec:org5097b5e}
\begin{frame}[label={sec:org284c688}]{What are Simulation, Emulation, Virtualization?}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org940265e}]{OS-Level Virtualization}
\begin{center}
\includegraphics[width=.7\columnwidth]{../../img/virtualization_concept.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org73e0ffc}]{OS-Level Virtualization: Scope of this Talk}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5cf7e6b}]{OS-Level Virtualization on Linux}
\begin{center}
\includegraphics[width=\columnwidth]{../../img/virtualization_normal_kernel.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org4fb8ce9}]{OS-Level Virtualization on Linux}
\begin{center}
\includegraphics[width=\columnwidth]{../../img/virtualization_kernel.pdf}
\end{center}
\end{frame}
\section{Containers on Linux}
\label{sec:org9e198fe}
\begin{frame}[label={sec:org17a2970}]{How do Containers Work?}
\begin{center}
\includegraphics[width=.81\columnwidth]{../../img/how-containers-work_pg0.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org53e9af8}]{How do Containers Work?}
Images used \alert{with permission}:
\begin{center}
\includegraphics[width=.72\columnwidth]{../../img/hcw_permission_twitter.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orga16da27}]{Containers on Linux are Just Processes}
\begin{center}
\includegraphics[width=.86\columnwidth]{../../img/how-containers-work_pg7.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orge3fdb30}]{Containers on Linux use Some Kernel Features}
\begin{center}
\includegraphics[width=.86\columnwidth]{../../img/how-containers-work_pg8.pdf}
\end{center}
\end{frame}
\section{Containers from Scratch}
\label{sec:org20a499d}
\begin{frame}[label={sec:orgec5f769},fragile]{Containers from Scratch: Obtaing an Image}
 \begin{columns}
...
\begin{frame}[label={sec:org34f07d0},fragile]{Containers from Scratch: Creating cgroups and Setting Limits}
...
\begin{frame}[label={sec:org8f219e1},fragile]{Containers from Scratch: Launching our Alpine Container}
 \begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgc3e5f57}]{Containers from Scratch: Resources}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{block}{Talks}
\begin{itemize}
...
\label{sec:org3230db2}
\begin{frame}[label={sec:orgfa58cc6},fragile]{The Docker API for Containers}
 \only<1>{
\begin{center}
...
\begin{frame}[label={sec:org865e856},fragile]{The Docker API for Containers}
