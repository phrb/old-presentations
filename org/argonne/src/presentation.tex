...
\begin{frame}[label={sec:org5023ef1}]{Autotuning: Search Spaces}
\begin{columns}
...
\label{sec:orgd8090b6}
\begin{frame}[label={sec:orgac8637c}]{Experimental Design: An Example on Agriculture}
\begin{columns}
...
\label{sec:orgf78ed92}
\begin{frame}[label={sec:org8a8b274}]{GPU Laplacian Kernel: A Motivating Example}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\label{sec:org6bd8000}
\begin{frame}[label={sec:orga35a8a5},fragile]{SPAPT: Search Problems in Automatic Performance Tuning}
 \begin{columns}
...
\begin{frame}[label={sec:org0a94bb4}]{SPAPT: Search Problems in Automatic Performance Tuning}
\begin{center}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org6bd6254}]{SPAPT: Search Problems in Automatic Performance Tuning}
\begin{center}
\begin{center}
