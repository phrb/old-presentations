...
\section{Autotuning}
\label{sec:orgabae3f8}
\begin{frame}[fragile,label={sec:org6fee88c}]{Autotuning: Optimizing Program Configurations}
 \begin{columns}
...
\begin{frame}[label={sec:org9ae6024}]{Autotuning: Search Spaces}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org5908366}]{Autotuning: Exploring Search Spaces}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6fe2efb}]{Autotuning: Multiple Approaches}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\label{sec:orgf233670}
\begin{frame}[label={sec:orgb3213f5}]{Applying Design of Experiments to Autotuning}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:orgbb234ec}]{Screening Designs}
\begin{columns}
\begin{column}{0.5\columnwidth}
\vspace{.4cm}
...
\begin{frame}[label={sec:orge76c541}]{Looking at Data: CUDA Compiler Flags}
\begin{columns}
...
\begin{frame}[label={sec:org622ea8b}]{Mixed-Level Designs}
\begin{columns}
\begin{column}{0.5\columnwidth}
\vspace{.1cm}
...
\begin{frame}[label={sec:orgb87d05c}]{Looking at Data: FPGA Compiler Parameters}
\begin{columns}
...
\label{sec:orgde44b59}
\begin{frame}[label={sec:orgca60a86}]{Design Efficiency: Introduction}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3751d18}]{Design Efficiency: Estimating Model Coefficients}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[fragile,label={sec:org0f496b7}]{Design Efficiency: The Dispersion Matrix}
 \begin{columns}
\begin{column}{0.5\columnwidth}
...
\label{sec:orgc0307f0}
\begin{frame}[label={sec:org2f40ac8}]{Perspectives}
\begin{columns}
\begin{column}{0.5\columnwidth}
