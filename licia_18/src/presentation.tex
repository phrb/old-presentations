...
\section{Autotuning}
\label{sec:orgf730322}
\begin{frame}[fragile,label={sec:org810265d}]{Autotuning: Optimizing Program Configurations}
 \begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org87e87ca}]{Autotuning: Multiple Approaches}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org47205a0}]{SPAPT: Summary}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5566e6f}]{Design Efficiency: Estimating Model Coefficients}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[fragile,label={sec:org7d1f548}]{Design Efficiency: The Dispersion Matrix}
 \addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org4bf97b5}]{Applying Design of Experiments to Autotuning}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{block}{Our Approach}
...
\begin{frame}[label={sec:org1798a43}]{Screening Designs}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.5\columnwidth}
\vspace{.4cm}
...
\begin{frame}[label={sec:orgfe13963}]{Looking at Data: CUDA Compiler Flags}
\addtocounter{framenumber}{-1}
\begin{columns}
...
\begin{frame}[label={sec:orgcdcfc12}]{Mixed-Level Designs}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.5\columnwidth}
\vspace{.1cm}
...
\begin{frame}[label={sec:org14c82d3}]{Looking at Data: FPGA Compiler Parameters}
\addtocounter{framenumber}{-1}
\begin{columns}
\begin{column}{0.4\columnwidth}
