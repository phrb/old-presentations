...
\label{sec:orgded3528}
\begin{frame}[label={sec:org33c1ee2}]{What are Simulation, Emulation, Virtualization?}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0f01b01}]{OS-Level Virtualization}
\begin{center}
\includegraphics[width=.7\columnwidth]{../../img/virtualization_concept.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org44592dd}]{OS-Level Virtualization: Scope of this Talk}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb9efd48}]{OS-Level Virtualization on Linux}
\begin{center}
\includegraphics[width=\columnwidth]{../../img/virtualization_normal_kernel.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org4fa1a8c}]{OS-Level Virtualization on Linux}
\begin{center}
\includegraphics[width=\columnwidth]{../../img/virtualization_kernel.pdf}
\end{center}
\end{frame}
\section{Containers on Linux}
\label{sec:org78828c0}
\begin{frame}[label={sec:orgdfe10ff}]{How do Containers Work?}
\begin{center}
\includegraphics[width=.81\columnwidth]{../../img/how-containers-work_pg0.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org3bf063a}]{How do Containers Work?}
Images used \alert{with permission}:
\begin{center}
\includegraphics[width=.72\columnwidth]{../../img/hcw_permission_twitter.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org5dd3c7a}]{Containers on Linux are Just Processes}
\begin{center}
\includegraphics[width=.86\columnwidth]{../../img/how-containers-work_pg7.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org29b2810}]{Containers on Linux use Some Kernel Features}
\begin{center}
\includegraphics[width=.86\columnwidth]{../../img/how-containers-work_pg8.pdf}
\end{center}
\end{frame}
\section{Containers from Scratch}
\label{sec:org8574e58}
\begin{frame}[label={sec:org2562343},fragile]{Containers from Scratch: Obtaing an Image}
 \begin{columns}
...
\begin{frame}[label={sec:org6f842ed},fragile]{Containers from Scratch: Creating cgroups and Setting Limits}
...
\begin{frame}[label={sec:org3976870},fragile]{Containers from Scratch: Launching our Alpine Container}
 \begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org56a42ca}]{Containers from Scratch: Resources}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{block}{Talks}
\begin{itemize}
...
\label{sec:org3430dbb}
\begin{frame}[label={sec:org7ce953d},fragile]{The Docker API for Containers}
 \only<1>{
\begin{center}
...
\begin{frame}[label={sec:org53356fb},fragile]{The Docker API for Containers}
